...
class Rectangle:
    ...
    def area(self):
        """
        Area of a rectangle from width and height returned values
        """
        return (self.width * self.height)

    def perimeter(self):
        """
        Perimeter of a rectangle from width and height returned values.
        """
    ...
    def __str__(self):
        ...
        representation using the # symbol.
        """
